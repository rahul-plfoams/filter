            ...
            <table class="table table-bordered text-center table-responsive">
              <thead>
                <tr>
                  ...
                  <td><img class="img img-fluid img-fluid-table w-100 p-2" src="img/back-position.png">
                    <!-- <figcaption>Back</figcaption> -->
                  </td>
                  <td><img class="img img-fluid img-fluid-table w-100 p-2" src="img/side-position.png">
                    <!-- <figcaption>Side</figcaption> -->
                  </td>
                  <td><img class="img img-fluid img-fluid-table w-100 p-2" src="img/stomach-position.png">
